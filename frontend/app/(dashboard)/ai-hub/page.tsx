...
const AREAS: AreaAI[] = [
  ...
  {
    key: "chat_financeiro",
    titulo: "Chat Financeiro",
    descricao:
      "Pergunte sobre os números reais do seu negócio e receba respostas na hora — um consultor que fala só do seu financeiro.",
    icon: MessageSquare,
    href: "/ai-hub/chat-financeiro",
    destaque: true,
    badge: "Novo",
  },
  {
