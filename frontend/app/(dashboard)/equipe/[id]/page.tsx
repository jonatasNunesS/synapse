...
function MetaCard({
  ...
  return (
    <Card className={meta.atingida ? "border-sucesso/30 dark:border-green-800" : ""}>
        ...
        <div className="flex items-start justify-between gap-2 mb-2">
          ...
          <div className="flex gap-1 flex-shrink-0">
            ...
            <Button
              variant="ghost"
              size="icon"
              className="h-7 w-7 text-erro hover:text-erro"
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex flex-col sm:flex-row items-start gap-5">
            ...
            {membro.total_metas > 0 && (
              <div className="flex items-center gap-2 bg-alerta/10 dark:bg-amber-900/20 rounded-lg px-4 py-3">
                <Trophy className="h-5 w-5 text-alerta" />
                <div>
