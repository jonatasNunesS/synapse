      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex flex-col sm:flex-row items-start gap-4">
            <div className="p-3 rounded-xl bg-brand-100 text-brand-600 dark:bg-brand-900/30 dark:text-brand-400 flex-shrink-0">
          ...
          {!documento.versoes || documento.versoes.length === 0 ? (
            ...
            <div className="space-y-3">
              {documento.versoes.map((versao) => (
                ...
                >
                  <div className="flex h-7 w-7 items-center justify-center rounded-full bg-brand-100 text-brand-600 dark:bg-brand-900/30 dark:text-brand-400 text-xs font-bold flex-shrink-0">
