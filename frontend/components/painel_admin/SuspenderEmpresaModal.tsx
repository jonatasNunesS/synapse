      ...
      <div className="w-full max-w-md rounded-xl border border-border bg-card shadow-xl">
        <div className="flex items-center justify-between px-5 py-3.5 border-b border-border">
          <h2 className="text-sm font-semibold text-foreground flex items-center gap-2">
            <PauseCircle className="h-4 w-4 text-erro" />
            Suspender empresa
          </h2>
        ...
        <div className="p-5 space-y-4">
          <p className="text-sm text-foreground-suave">
            <span className="font-medium text-foreground">{empresaNome}</span> ficará suspensa. Os
          ...
          <div>
            <label className="text-xs text-muted-foreground block mb-1">
              Motivo da suspensão <span className="text-erro">*</span>
            </label>
            <textarea
              value={motivo}
              ...
              className="w-full resize-none rounded-lg border border-border bg-secondary px-3 py-2 text-sm text-foreground placeholder:text-muted-suave focus:outline-none focus:ring-1 focus:ring-red-500"
            />
            <p className="text-[0.6875rem] text-muted-suave mt-1">
